...
public final class ConnectionIdentifierShape {
   ...
   * bag in the same precedence order {@link
   * net.snowflake.client.internal.jdbc.SnowflakeConnectString#parse(String, Properties)} uses:
   * URL-query first, then Properties overwrites. Returns {@code null} when neither source supplies
   * a non-empty value.
   */
